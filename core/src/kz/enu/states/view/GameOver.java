...
public class GameOver extends kz.enu.states.model.State {
    ...
    public GameOver(kz.enu.states.model.GameStateManager gsm) {
        super(gsm);
        ...
        String item = kz.enu.states.game.PlayState.getResult();
        glyphLayout.setText(TheTogyzQumalaq.getMainFont(), item);
        w = glyphLayout.width;
        glyphLayout.reset();
        glyphLayout.setText(TheTogyzQumalaq.getMainFont(), kz.enu.states.game.PlayState.getGameOverWords());
    ...
    public void render(SpriteBatch sb) {
        ...
        TheTogyzQumalaq.getMainFont().draw(sb, kz.enu.states.game.PlayState.getGameOverWords(), (TheTogyzQumalaq.WIDTH - w1) / 2, 350f);
        TheTogyzQumalaq.getMainFont().draw(sb, kz.enu.states.game.PlayState.getResult(), (TheTogyzQumalaq.WIDTH / 2) - (w / 2), TheTogyzQumalaq.HEIGHT / 2);
        sb.end();
    }
